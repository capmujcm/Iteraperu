...
// clave ya habia caducado y tenia que volver al Punto de Ayuda. Dura la
// jornada; sigue siendo de un solo uso porque obliga a cambiarla al entrar.
const TEMP_PASSWORD_PUERTA_TTL_MS = 14 * 60 * 60 * 1000; // 14 horas
