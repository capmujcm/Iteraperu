...
module.exports = function registrarSorteo(fastify, opciones) {
  ...
  fastify.post('/api/sorteo/premios', {
    ...
    try {
      const premio = await store.createPremio(eventoId, orden, nombre, texto(b.descripcion, 500));
  ...
  fastify.post('/api/sorteo/jugar', {
    ...
    return reply.code(201).send({
      success: true,
      premio: { id: premio.id, orden: premio.orden, nombre: premio.nombre, descripcion: premio.descripcion },
